      ...
      <main className="pt-6 pb-12">
        <div className="container">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8 text-center">
            <h1 className="mb-2 font-display text-3xl font-extrabold sm:text-4xl">Free Programming Meme Generator</h1>
            <p className="text-muted-foreground">Create programming memes online with our free meme generator and browse trending developer memes</p>
          </motion.div>
          ...
          <div className="mx-auto mt-8 max-w-3xl space-y-3 text-sm text-muted-foreground leading-relaxed">
            ...
            <p>
            Our meme generator allows developers to create their own programming memes instantly. You can add multiple text layers, customize fonts and colors, and download your meme for sharing on social media or developer communities. Whether you are a software engineer, student learning to code, or simply someone who enjoys tech humor, this page provides both a meme creation tool and a curated feed of trending developer memes.
            </p>
          </div>
