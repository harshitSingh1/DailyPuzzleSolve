...
const sections = [
  {
    title: "Introduction",
    content:
      "At LogicPuzzleHub, we respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard your data when you use our website and services.",
  },
  {
...
export default function PrivacyPage() {
  ...
  const jsonLd = {
    ...
    description:
      "Learn how LogicPuzzleHub collects, uses, and protects your personal information.",
