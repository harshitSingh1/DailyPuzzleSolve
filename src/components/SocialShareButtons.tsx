...
const SocialShareButtons = memo(({ url, title, className = "" }: SocialShareButtonsProps) => {
  ...
  const copyLink = () => {
    ...
    toast({ title: "Link copied!", description: "Share it with friends to help them solve today's puzzle." });
  };
  ...
  return (
    <div className={`flex flex-wrap gap-2 ${className}`}>
      ...
      <Button variant="outline" size="sm" className="gap-1.5 rounded-full ml-auto" onClick={copyLink}>
