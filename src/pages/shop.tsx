...
// Lazy load the AdSense component since it's not critical for initial render
...
const ShopItemCard = React.memo(({ item, getItemsPerRow, theme }: { 
  item: ShopItem, 
  getItemsPerRow: () => number, 
  theme: Theme 
}) => {
  const { cleanDescription, price, discount } = useMemo(() => {
