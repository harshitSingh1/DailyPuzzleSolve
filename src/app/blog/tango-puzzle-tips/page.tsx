...
export const metadata: Metadata = {
  ...
  description:
    "Learn the systematic approach to solving LinkedIn Tango puzzles. No guessing needed. Master forced moves, balance counting, and constraint propagation.",
  alternates: {
    canonical: `${SITE_URL}/blog/tango-puzzle-tips`,
  },
  openGraph: {
    title: "LinkedIn Tango Puzzle Tips - Solve It Every Time Without Guessing",
    description:
      "Learn the systematic approach to solving LinkedIn Tango puzzles.",
    url: `${SITE_URL}/blog/tango-puzzle-tips`,
    siteName: SITE_NAME,
    type: "article",
  },
};

export default function TangoPuzzleTipsPage() {
  const jsonLd = {
        ...
        <div className="container max-w-3xl mx-auto">
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <img
              ...
              alt="LinkedIn Tango puzzle grid"
            ...
            <div className="space-y-6 text-foreground leading-relaxed">
              ...
              <h2 className="font-display text-2xl font-bold text-foreground mt-8">
                Technique 1: Spot Forced Moves First
              </h2>
              ...
              <h2 className="font-display text-2xl font-bold text-foreground mt-8">
                Technique 3: Use the Triple Rule Proactively
              </h2>
              ...
              <h2 className="font-display text-2xl font-bold text-foreground mt-8">
                Technique 4: Work From the Edges
              </h2>
              ...
              <p>
                If you are truly stuck, check our{" "}
                <Link
                  href="/solutions/tango"
                  className="text-primary hover:underline"
                >
                  daily Tango solutions page
                </Link>{" "}
                for today's answer with reasoning for each cell.
              </p>
