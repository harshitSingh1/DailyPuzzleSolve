...
const ORIGINAL_ARTICLES = [
  {
    ...
    description:
      "Proven strategies for guessing the Pinpoint answer in fewer clues. Master category thinking, elimination, and word association.",
  ...
  },
  {
    ...
    description:
      "Science-backed methods to improve memory, focus, and pattern recognition. Spaced repetition, working memory exercises, and deliberate practice.",
  ...
  },
  {
    ...
    description:
      "Complete strategies for Pinpoint, Queens, Tango, Crossclimb, Zip, and Mini Sudoku. Tips from experienced solvers.",
  ...
  },
  {
    ...
    description:
      "Constraint-based solving, backtracking, and pattern recognition. A systematic approach that eliminates guessing.",
  ...
  },
  {
    ...
    description:
      "Master forced moves, balance counting, and the triple rule. Systematic techniques for consistent solves.",
      ...
      <main className="pt-6 pb-12">
        <div className="container max-w-5xl">
          ...
          <p className="mb-8 text-center text-muted-foreground max-w-2xl mx-auto">
            In-depth strategy guides, brain training articles, and daily solving tips written by our editorial team.
            Learn the reasoning behind every puzzle so you can solve tomorrow's on your own.
          </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              {ORIGINAL_ARTICLES.map((article, i) => (
                ...
                >
                  ...
                  <Link
                    href={article.path}
                    className="flex flex-col h-full overflow-hidden rounded-xl border bg-card shadow-sm hover:-translate-y-1 hover:shadow-md transition-all"
                  >

                    <div className="flex flex-1 flex-col p-4">

                      <h3 className="mb-1 font-display text-base font-bold line-clamp-2">
                        {article.title}
                      </h3>
          ...
          {isLoading ? (
            ...
            <motion.article
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-8 overflow-hidden rounded-xl border bg-card shadow-sm md:flex"
            >
              ...
              <div className="flex flex-1 flex-col justify-between p-6">
                ...
                <div>
                  ...
                  <h2 className="mb-2 font-display text-xl font-bold line-clamp-2">
                    {featuredPost.title}
                  </h2>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-xs">
                      ...
                      <p className="text-muted-foreground">
                        {featuredPost.readable_publish_date} ·{" "}
          ...
          <div className="mt-8 rounded-xl border bg-muted/30 p-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Our blog curates the latest insights, tutorials, and trends in programming,
              technology, and software development. We source top articles from leading
              developers to help puzzle enthusiasts and coders stay ahead of the curve.
            </p>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              {[
                ...
                <span
                  key={q}
                  className="rounded-full bg-background border px-3 py-1 text-xs text-muted-foreground"
                >
                  {q}
                </span>
              ))}
